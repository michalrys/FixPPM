...
(function () {
    ...
    function insertHours() {
        ...
        hiWindow.document.writeln("            </td>");
        hiWindow.document.writeln("            <td>");
        hiWindow.document.writeln("                <input type=\"text\" id=\"filterTasks\" value=\"\" onkeyup=\"findTasksFilterAndSetToMenu()\" onmouseover=\"filterTasksInfo()\">");
        hiWindow.document.writeln("            </td>");
        hiWindow.document.writeln("        </tr>");
        hiWindow.document.writeln("        <tr>");
        hiWindow.document.writeln("            <td>");
        ...
        hiWindow.document.writeln("                <input type=\"button\" id=\"insertButton\" value=\"INSERT\" onclick=\"insertHours()\" onmouseover=\"insertButtonInfo()\">");
        hiWindow.document.writeln("                <input type=\"button\" id=\"removeButton\" value=\"REMOVE\" onclick=\"removeHours()\" onmouseover=\"removeButtonInfo()\">");
        hiWindow.document.writeln("                <input type=\"button\" id=\"convertJiraReportButton\" value=\"convJira\" onclick=\"convertJiraReport()\" onmouseover=\"convertJiraReportInfo()\">");
        hiWindow.document.writeln("                <input type=\"button\" id=\"writeToTxtButton\" value=\"writeTXT\" onclick=\"writeToTxtFile()\" onmouseover=\"writeToTxtButtonInfo()\">");
        hiWindow.document.writeln("                <input type=\"button\" id=\"readTxtButton\" value=\"parseTXT\" onclick=\"readTxtFile()\" onmouseover=\"readTxtButtonInfo()\">");
        hiWindow.document.writeln("            </td>");
        hiWindow.document.writeln("        </tr>");
        hiWindow.document.writeln("        <tr>");
