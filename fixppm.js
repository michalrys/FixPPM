...
// @version      1.8.13
// @description  Fixes for adding partial hours % 0.5 != 0.
...
(function () {
    ...
    function insertHours() {
        ...
        hiWindow.document.writeln("        status.textContent = \"xls 2 ? read xls report from Jira (Group By PPM Project 20xx, Issue) and covert to input txt file.\";");
        hiWindow.document.writeln("    }");
        hiWindow.document.writeln(" ");
        hiWindow.document.writeln("    function convertJiraReportInfo() {");
        hiWindow.document.writeln("        status.textContent = \"xls ? read xls report from Jira (Group By PPM Project 20xx) and covert to input txt file.\";");
        hiWindow.document.writeln("    }");
        hiWindow.document.writeln(" ");
        ...
        hiWindow.document.writeln("        var bgColorPartialHoursWarning = \"rgb(255, 255, 124)\";");
    ...
    function validateAndColorInput(object) {
        ...
        if (!isNaN(nodeValue) && (object.value.length > 4 || nodeValue > maxHoursDaily)) {
