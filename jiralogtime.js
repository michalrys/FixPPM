...
// @version      1.0.3
// @description  Add simple pseudo-batch mode extension.
// @author       Michał Ryś
...
(function () {
    ...
    //pseudoBatchDiv.textContent = 'Hello World!';

    let mySubTaskLabel = document.createElement('label');
    mySubTaskLabel.id = "mySubTaskLabel";
    mySubTaskLabel.for = "mySubTaskSelect";
    mySubTaskLabel.textContent = "Subtask:"

    let mySubTaskSelect = document.createElement('select');
    mySubTaskSelect.id = "mySubTaskSelect";
    mySubTaskSelect.style = "height: 18px; width: 250px; font-size: 10px; color: #6B778C; margin-left: 10px; margin-right: 10px; outline: 0px SOLID #6B778C; border: unset; background: #fafafa";
