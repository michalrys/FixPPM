    ...
    function setPPMTaskSubtasks() {
        ...
        ppmTaskSubtasks.set("Business initiatives (CAPEX)",
            ["Task: Analysis and Review",
                ...
                "Task: Test Execution"]);
        ppmTaskSubtasks.set("Small medium features (CAPEX)",
            ["Task: Analysis and Review",
                "Task: Bug Fixing and Rework",
                "Task: Build and Release",
                "Task: Implementation",
        ...
        ppmTaskSubtasks.set("Keep running (OPEX)",
            ["Task: 3rd level support",
                ...
                "Task: Test Case Specification",
                "Task: Test Execution"]);
        ppmTaskSubtasks.set("IT4IT (OPEX)",
            ["Task: Analysis and Review",
                "Task: Bug Fixing and Rework",
                "Task: Build and Release",
                "Task: Implementation",
                "Task: Test Case Specification",
                "Task: Test Execution"]);
        ppmTaskSubtasks.set("Small medium features (OPEX)",
            ["Task: Analysis and Review",
                "Task: Bug Fixing and Rework",
                "Task: Build and Release",
                "Task: Implementation",
                "Task: Test Case Specification",
                "Task: Test Execution"]);
        ppmTaskSubtasks.set("FashionID",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Baby Waltz",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Other",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Breuninger",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Fashionette",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Klingel",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Lidl",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Conrad Electronics",
            ["Task: Development"]);
        ppmTaskSubtasks.set("OTTO",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Zalando",
            ["Task: Development"]);
        ppmTaskSubtasks.set("Postbank",
            ["Task: Development"]);
        ppmTaskSubtasks.set("VW Payments",
            ["Task: Development"]);
        ppmTaskSubtasks.set("PM Activities (OPEX)",
            ["Task: Planning, agile meetings"]);
        ppmTaskSubtasks.set("CRIF trainings and events",
            ["Task: BHP training"]);
        ppmTaskSubtasks.set("Asset",
            ["Req: 442333"]);
