...
// @version      1.0.7
// @description  Simplify settings: 3 steps; update checking PPM Task name vs Jira task name
// @author       Michał Ryś
...
(function () {
    ...
    const prefix = [];
    prefix.push("XYZ - 123456 - ABC");
    prefix.push("ZXW - 123457 - ASD - XYZ");
    ...
    ppmTaskNames.forEach(function(ppmTaskName) {
        prefix.forEach(function(pref) {
            ...
            if(jiraNamePPMTaskName.get(ppmName) === undefined) {
                ...
                let tempValue = jiraNamePPMTaskName.get(ppmName)
...
// add select and options
    ...
    Calendar.setup({
        ...
        date         : "2023/04/05 11:15:32",
        todayDate    : "2023/04/05 11:15:32",
        timeFormat   : "12"
    });
