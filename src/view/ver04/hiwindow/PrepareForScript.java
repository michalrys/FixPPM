...
public class PrepareForScript {
    public static void main(String[] args) {
        File file = new File("src/view/ver04/hiwindow/hoursInsert_6_some_bug_fix.html");
        if (!file.exists()) {
        ...
        File fileResults = new File("src/view/ver04/hiwindow/converted_6.txt");
