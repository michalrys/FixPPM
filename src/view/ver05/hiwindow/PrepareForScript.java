...
public class PrepareForScript {
    public static void main(String[] args) {
        File file = new File("src/view/ver05/hiwindow/hoursInsert_8_refactoring.html");
        if (!file.exists()) {
        ...
        File fileResults = new File("src/view/ver05/hiwindow/converted_8.txt");
