...
public class PrepareForScript {
    public static void main(String[] args) {
        File file = new File("src/view/ver01/hiwindow/hoursInsert_5_parsing_file.html");
        if (!file.exists()) {
        ...
        File fileResults = new File("src/view/ver01/hiwindow/converted_5.txt");
