...
public class PrepareForScript {
    public static void main(String[] args) {
        File file = new File("src/view/ver06/hiwindow/hoursInsert_10_refactoring.html");
        if (!file.exists()) {
        ...
        File fileResults = new File("src/view/ver06/hiwindow/converted_10.txt");
